...
//   const userName = localStorage.getItem("userName");
//   const navigate = useNavigate();
//   const { state } = useLocation(); // Get restaurant name from the state passed in navigation
//   const [isBasketVisible, setIsBasketVisible] = useState(false);
...
//     e.preventDefault();
//     if (cart.length === 0) {
//       toast.error('Please add items for checkout');
//       return;
//     }
...
//         </div>
//       </div>
//       <div className={styles.resturentName}>{state?.restaurantName}</div> {/* Display restaurant name */}
//       <div className={styles.header}>
//         <h4 id={styles.selectedlink}>Offers</h4>
//         <h4>Burgers</h4>
//         <h4>Fries</h4>
